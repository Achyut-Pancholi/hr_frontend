...
function initShareView() {
  ...
  // Hide the sidebar so the report spans full width
  ...
  // Make full-report-page span full screen (no sidebar offset)
  const fp = document.getElementById('full-report-page');
  if (fp) {
    fp.style.left = '0';
  }

  // Hide "Back to Reports" and "Generate Share Link" — read-only view
  ...
  // Add a read-only footer note to the overview tab body
